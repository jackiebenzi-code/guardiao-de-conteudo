...
// Mantém a sessão do responsável viva entre requisições e protege as rotas
// internas: sem sessão válida, redireciona para /login antes de tocar em
// qualquer dado (defesa em profundidade, além do RLS no banco).
